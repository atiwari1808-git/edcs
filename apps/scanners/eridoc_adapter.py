...
DocumentScanner (vendor/edcs_core). See README.md "Integration" section.
...
def _run_demo(jira_id: str) -> ScanResult:
    ...
    if last.isdigit() and int(last) % 2 == 1:
        r.missing_documents = [{
            ...
            "detail": f"Mandatory document 'RELEASE_NOTE' not found in folder {jira_id}",
